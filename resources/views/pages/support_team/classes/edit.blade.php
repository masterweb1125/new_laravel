                    ...
                    <form class="ajax-update-class-subject" data-reload="#page-header" method="post" action="{{ route('classes.update', $classId) }}">
                        ...
                        <div class="row">
                            ...
                            @foreach ($all_subjects as $subject) 
                                ...
                                <input type="checkbox" id="{{$subject->subject_type->name.$subject->title}}" name="{{$subject->subject_type->name.$subject->title}}" value="{{$subject->id}}" @if(in_array($subject->id, $myclasssubject)) checked  @endif >
