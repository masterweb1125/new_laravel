            ...
            let tbody = myObj.parentNode.parentNode.parentNode.parentNode.children;
                ...
                td2.innerHTML = 
                    `<div class="d-flex align-items-center justify-content-start">                                            
                        ...
                        <a class="btn" title="Delete this user" onclick="editingGroupName('`+ origin_group_name +`', this);">
        ...
        req.done(function(resp){
            ...
            myObj.parentNode.parentNode.innerHTML =                                                 
                `<div class="d-flex align-items-center justify-content-start">                                            
                    ...
                    <a class="btn" title="Delete this user" onclick="editingGroupName('`+ updated_group_name +`', this);">
                        <img src="/global_assets/images/icon/edit.png" width="20" height="20"/>
                    </a>
                </div>`;
            edit_status = false;
