...
class Qs
{
 ...
 <div class="alert alert-success alert-bordered">
    ...
    {
        return in_array(Auth::user()->user_type->title, self::getTeamAccount());
    }

    public static function userIsTeamSA()
    {
        return in_array(Auth::user()->user_type->title, self::getTeamSA());
    }

    public static function userIsTeamSAT()
    {     
        return in_array(Auth::user()->user_type->title, self::getTeamSAT());
    }

    public static function userIsAcademic()
    {
        return in_array(Auth::user()->user_type->title, self::getTeamAcademic());
    }

    public static function userIsAdministrative()
    {
        return in_array(Auth::user()->user_type->title, self::getTeamAdministrative());
    }

    public static function userIsAdmin()
    {
        return Auth::user()->user_type->title == 'admin';
    }

    public static function getUserType()
    {
        return Auth::user()->user_type->title;
    }

    public static function userIsSuperAdmin()
    {
        return Auth::user()->user_type->title == 'super_admin';
    }

    public static function userIsStudent()
    {
        return Auth::user()->user_type->title == 'student';
    }

    public static function userIsTeacher()
    {
        return Auth::user()->user_type->title == 'teacher';
    }

    public static function userIsParent()
    {
        return Auth::user()->user_type->title == 'parent';
    }

    public static function userIsStaff()
    {
        return in_array(Auth::user()->user_type->title, self::getStaff());
    }
    ...
    {
        return in_array(Auth::user()->user_type->title, self::getPTA());
    }
    ...
    {
        return 'uploads/'.$user_type->title.'/';
    }
